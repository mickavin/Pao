...
export function MedicationInfiniteList({
  ...
  const [medications, setMedications] = useState<State[]>(initialMedications)
  const [count, setCount] = useState(initialMedications.length)
  ...
  console.log("initialMedications", initialMedications)
    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="relative">
            ...
            </div>
            {
              ...
              <p className="text-sm text-muted-foreground">{medications.length} médicament(s) dans votre liste</p>
            }
